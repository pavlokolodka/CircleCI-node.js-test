...
-- AddForeignKey
ALTER TABLE "Volunteer_hint_photo" ADD CONSTRAINT "Volunteer_hint_photo_hint_id_fkey" FOREIGN KEY ("hint_id") REFERENCES "Volunteer_hint"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
